...
- Turn on **hide mode** to hide notes marked with any configured hidden tag.
- Turn it off to show all notes again.
- Open plugin settings to maintain your hidden-tag list and graph behavior.
